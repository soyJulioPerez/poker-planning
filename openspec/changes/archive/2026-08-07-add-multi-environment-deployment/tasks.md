...
- [x] 8.4 Disparo manual de `workflow_dispatch` con `environment: prod` y `ref` a un tag anterior redepliega esa versión sin mover el puntero de `master` — verificado en vivo, run [31137523825](https://github.com/soyJulioPerez/poker-planning/actions/runs/31137523825), éxito en 2m10s; confirmado en el log que el checkout usó `ref: v1.0.0`, y `origin/master` quedó en el mismo hash (`f31259b7`) antes y después
