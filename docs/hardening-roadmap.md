...
> - **Umbral final**: Statements 38%, Branches 47%, Functions 26%, Lines 43% (medido: 38.64/48/26.35/43.44). Son números bajos comparados con `realtime-api` (86/76/95/86) porque la mayoría de los componentes de UI de `apps/web` siguen sin test — el umbral fija el piso de hoy, no certifica que la cobertura sea buena.
